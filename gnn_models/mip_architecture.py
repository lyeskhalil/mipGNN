...
class Net(torch.nn.Module):
    def __init__(self, dim):
        ...
        self.conv1 = MIPGNN(dim, dim, 2, 1, root_weight=True, bias=True, num_bases=5)
        self.conv2 = MIPGNN(dim, dim, 2, 1, root_weight=True, bias=True, num_bases=5)
        self.conv3 = MIPGNN(dim, dim, 2, 1, root_weight=True, bias=True, num_bases=5)
